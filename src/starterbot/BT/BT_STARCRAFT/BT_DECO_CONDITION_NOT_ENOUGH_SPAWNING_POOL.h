...
// 
//--------------------
class BT_DECO_CONDITION_NOT_ENOUGH_SPAWNING_POOL : public BT_DECO_CONDITION
{
public:
    BT_DECO_CONDITION_NOT_ENOUGH_SPAWNING_POOL(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool IsThereNotEnoughSpawningPool(void* data);
