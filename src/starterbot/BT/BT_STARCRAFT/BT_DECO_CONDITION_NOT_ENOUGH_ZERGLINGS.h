...
// 
//--------------------
class BT_DECO_CONDITION_NOT_ENOUGH_ZERGLINGS : public BT_DECO_CONDITION
{
public:
    BT_DECO_CONDITION_NOT_ENOUGH_ZERGLINGS(std::string name, BT_NODE* parent);
    std::string GetDescription() override;

    static bool IsThereNotEnoughZerglings(void* data);
